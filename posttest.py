...
def send_data():
    print(requests.post(host, data={"sensorname":sensname, "temp":random.randint(24,35), "humidity":random.randint(30,80), "pressure":random.randint(950,1150), "altitude":random.randint(95, 115), "NO2":random.randint(1,10), "CO2":random.randint(1,10), "NH3":random.randint(1,10), "CO":random.randint(1,10)}).text)
